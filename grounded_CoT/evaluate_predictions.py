...
def evaluate_single_answer(
    ...
    if t_f is not None and p_f is not None:
        ...
        score = 1.0 if change <= max_relative_change else 0.0
        # return score
        change1 = abs(p_f * 100 - t_f) / abs(t_f)
        score1 = 1.0 if change1 <= max_relative_change else 0.0
        change2 = abs(p_f / 100 - t_f) / abs(t_f)
        score2 = 1.0 if change2 <= max_relative_change else 0.0
        return max(score, score1, score2)
    # Fallback text
    #print("P:", p, "T: ", t)
